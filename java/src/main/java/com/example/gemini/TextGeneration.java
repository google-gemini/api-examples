...
public class TextGeneration {
    ...
    public static @Nullable String textGenMultimodalOneImagePrompt() throws Exception {
        ...
        GenerateContentResponse response = client.models.generateContent("gemini-3-flash-preview", content, null);
    ...
    public static String textGenMultimodalMultiImagePromptStreaming() throws Exception {
        ...
        ResponseStream<GenerateContentResponse> responseStream =
                client.models.generateContentStream("gemini-3-flash-preview", content, null);
