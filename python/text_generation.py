...
class UnitTests(absltest.TestCase):
    ...
    def test_text_gen_text_only_prompt(self):
        ...
        response = client.models.generate_content(
            model="gemini-3-flash-preview", contents="Write a story about a magic backpack."
        )
        print(response.text)
    ...
    def test_text_gen_multimodal_one_image_prompt(self):
        ...
        response = client.models.generate_content(
            model="gemini-3-flash-preview", contents=["Tell me about this instrument", organ]
        )
        print(response.text)
    ...
    def test_text_gen_multimodal_video_prompt(self):
        ...
        response = client.models.generate_content(
            model="gemini-3-flash-preview", contents=[myfile, "Describe this video clip"]
        )
